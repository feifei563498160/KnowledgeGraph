...
path_log_output=path_project+os.sep+"output"+os.sep+"log_pattern_acquire_auto7_8.txt"
...
#                 if attribute_name in attribute2instancesNum:
#                     attribute2instancesNum[attribute_name]+=1
#                 else:
#                     attribute2instancesNum[attribute_name]=1
...
def test_merge_similar_patterns():
